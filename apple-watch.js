function watch_animation(ele) {
    document.querySelector(".show-image img").src = ele;
...
function calculate_price() {
    ...
    // console.log(`Your total price is ${watch_total} </br> Discounted Amount is ${discount}  with ${watch_discount} discount </br> So, Sub-Total is ${sub_total} </br> With 13 % Tax Total Price ${final_tot}  )
}